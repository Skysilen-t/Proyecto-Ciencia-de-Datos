...
2. Acceder a la carpeta Preguntas y ejecutar los notebooks
3. Ejecutar el notebook *pregunta_1* para conocer la información que registramos en nuestro archivo.
4. Ejecutar el notebook *pregunta_2* para visualizar los mayores terremotos por región.
5. Ejecutar el notebook *pregunta_3* para encontrar el area de mayor riesgo en el país.
6. Ejecutar el notebook *pregunta_4* para calcular el tiempo promedio en que ocurren los terremotos
7. Ejecutar el notebook *pregunta_5* para generar el modelo predictivo de lugares de riesgo